				      ...
				      <div class="col-md-9 personal-info">
				        ...
				        <div class="form-group">
		            	  ...
		            	  ?>
          				  ...
          				  <div class="form-group">
				            <label class="col-lg-3 control-label">Total Marks:</label>
				            <div class="col-lg-8">
											...
											<table class="table table-bordered table-hover" id="tab_logic">
												<thead>
													<tr >
														...
														<th class="text-center">Avaliable Marks</th>
													</tr>
												</thead>
												<tbody>
													<tr id='addr0'>
														...
														<td>
															<input type="text" name='smarks[]' placeholder='Avaliable Marks' class="form-control"/>
														</td>
													</tr>
								                    <tr id='addr1'></tr>
												</tbody>
...
<script type="text/javascript">
     ...
     $("#add_row").click(function(){
      $('#addr'+i).html("<td>"+ (i+1) +"</td><td><input name='sname[]"+i+"' type='text' placeholder='Area Name' class='form-control input-md'  /> </td><td><input  name='squestions[]"+i+"' type='text' placeholder='Questions'  class='form-control input-md'></td><td><input  name='smarks[]"+i+"' type='text' placeholder='Avaliable Marks'  class='form-control input-md'></td>");
