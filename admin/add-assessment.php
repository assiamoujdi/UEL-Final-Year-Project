					        ...
					        <div class="form-group">
											        ...
											        <div class="form-group">
													  ...
													  <div class="form-group">
											            ...
											            <div class="col-lg-8">
															...
															<br>
															<div class="container"> 
																<div class="alert alert-danger" role="alert" style="display: none; width: 100%; margin-left: -200px;" id="notifyUser">
																...
																<div class="alert alert-danger" role="alert" style="display: none; width: 100%; margin-left: -200px;" id="percentageValue">
																...
																<div class="alert alert-warning" role="alert" style="display: none; width: 100%; margin-left: -200px;" id="percentageAvaliable">
							  ...
							  <div class="form-group">
					            ...
					            <br>
									...
									<br>
									<div class="container">
										<div class="alert alert-danger" role="alert" style="display: none; width: 100%; margin-left: -200px;" id="alertUser">
										...
										<div class="alert alert-danger" role="alert" style="display: none; width: 100%; margin-left: -200px;" id="weightValue">
										...
										<div class="alert alert-warning" role="alert" style="display: none; width: 100%; margin-left: -200px;" id="weightAvaliable">
