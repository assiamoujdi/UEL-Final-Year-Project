            ...
            <table class="table">
                <thead>
                    <tr class="filters">
                        ...
                        <th><input type="text" class="form-control" placeholder="Assessment 1" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Assessment 2" disabled></th>
                        <th><input type="text" class="form-control" placeholder="Assessment 3" disabled></th>
                ...
                <tbody>
                    <?php
                        ...
                        {
                         $query = "
                          SELECT DISTINCT module_code, module_name, module_leader, description, assessment1, assessment2, assessment3 FROM module ORDER BY module_code asc
                         ";
                        }
                        ...
                        $module = $row["module_code"];
                          ...
                          $output .= '
                           <tr>
                            ...
                            <td>'.$row["assessment1"].'</td>
                            <td>'.$row["assessment2"].'</td>
                            <td>'.$row["assessment3"].'</td>
                              ...
                              <div class="btn-group">
                                  <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu" role="menu">
                                      <li>
                                        <a href="edit-module.php?id=' . $module . '">Edit Module</a>
                                      </li>
                                      <li>
                                        <a href="remove-module.php?id=' . $module . '">Remove Module</a>
                                      </li>
                                      <li>
                                        <a href="add-assessment.php?id=' . $module . '">Add Assessment</a>
                                      </li>
                                      <li>
                                        <a href="marking-scheme.php?id=' . $module . '">Add Marking Scheme</a>
                                      </li>
                                      <li>
                                        <a href="marking-scheme-form.php?id=' . $module . '">Mark Student With Marking Scheme</a>
                                      </li>
                                      <li>
